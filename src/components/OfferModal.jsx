...
function OfferModal() {
  const deals = [{
    text: "100 off",
    desc: "on bill value of 599 or more"
  },
  {
    text: "200 off",
    desc: "on bill value of 999 or more"
  },
  {
    text: "300 off",
    desc: "on bill value of 1300 or more"
  }
  ]
  return( 
    <>
    ...
    aria-label = "Close" > </button> </div> <div className = "offcanvas-body px-3 pt-3" > {deals.map(data =>
